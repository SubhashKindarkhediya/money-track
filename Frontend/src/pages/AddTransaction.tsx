        ...
        <div className="flex border-b border-indigo-100/30 dark:border-gray-800/50 bg-white/50 dark:bg-[#151624]/30">
          <button
            ...
            className={`flex-1 py-4 text-sm font-black transition-all relative ${
              mode === "single" ? "text-indigo-600 dark:text-indigo-400" : "text-gray-400 dark:text-gray-500"
            }`}
          >
            Single
            {mode === "single" && (
          ...
          <button
            ...
            className={`flex-1 py-4 text-sm font-black transition-all relative ${
              mode === "group" ? "text-indigo-600 dark:text-indigo-400" : "text-gray-400 dark:text-gray-500"
            }`}
          >
            Group
            {mode === "group" && (
